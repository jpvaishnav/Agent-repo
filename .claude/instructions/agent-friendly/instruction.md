...
description: Guidelines for making this repository agent-friendly for Claude/Copilot agents.
version: 0.1.0
author: Copilot CLI
tags:
  - instructions
...
- Add a `.claude/skills.json` manifest for explicit registration when needed.
- Provide human- and agent-readable `skill.md` with name, description, entrypoint, usage, and tags.
- Place repository-wide instructions in `.claude/instructions/` so agents can discover context and rules.
